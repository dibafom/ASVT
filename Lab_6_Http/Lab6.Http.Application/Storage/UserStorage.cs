...
class TaskStorage : StorageBase<TaskItem>, ITaskApi
{
    private static readonly Dictionary<int, TaskItem> defaultData
        ...
        {
            [1] = new TaskItem(1, "Moscow", "Rain"),
            [2] = new TaskItem(2, "Kazan", "Rain"),
            [3] = new TaskItem(3, "Nizhnekamsk", "Rain"),
            [4] = new TaskItem(4, "Yekaterinburg", "Rain"),
            [5] = new TaskItem(5, "Yoshkar-Ola", "Rain"),
            [6] = new TaskItem(6, "Kaliningrad", "Rain"),
            [7] = new TaskItem(7, "Naberezhnye Chelny", "Rain"),
            [8] = new TaskItem(8, "Vladikavkaz", "Rain"),
            [9] = new TaskItem(9, "Almetyevsk", "Rain")
        };
